...
<title>rsc-xray report</title><style>${STYLE}</style></head>
<body><div class="wrap">
<h1>rsc-xray <span class="dim">v${esc(version)}</span></h1>
...
<footer>Generated by rsc-xray — static analysis, no app execution. <span class="dim">[shared] = both envs · [client*] = client-bundled without a directive</span></footer>
</div></body></html>`;
}
