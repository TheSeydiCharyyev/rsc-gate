...
|---|---|---|
| `framework-4f2a1c.js` | a `node_modules` client module, plus Card and Badge | framework |
...
That layout is what makes the fixture worth having: it pins the framework/own
